...
/proc/pencode2html(t)
	...
	t = replacetext(t, "\[fcacrest\]", "<img src = fcalogo.png>")
	t = replacetext(t, "\[pycologo\]", "<img src = pycologo.png>")
...
/proc/html2pencode(t)
	...
	t = replacetext(t, "<img src = fcalogo.png>", "\[fcacrest\]")
	t = replacetext(t, "<img src = pycologo.png>", "\[pycologo\]")
