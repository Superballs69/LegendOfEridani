...
/obj/machinery/navbeacon/eclipse/bridge2
	location = "bridge2"
	codes = list("patrol" = 1, "next_patrol" = "rdoffice")

/obj/machinery/navbeacon/eclipse/vault2
	location = "vault2"
	codes = list("patrol" = 1, "next_patrol" = "medical")

/obj/machinery/navbeacon/eclipse/vault1
	location = "vault1"
	codes = list("patrol" = 1, "next_patrol" = "xooffice")

/obj/machinery/navbeacon/eclipse/medical
	location = "medical"
...
/obj/machinery/navbeacon/eclipse/rdoffice
	location = "rdoffice"
	codes = list("patrol" = 1, "next_patrol" = "vault2")

// eclipse delivery types

/obj/machinery/navbeacon/eclipse/QM3
	location = "QM #3"
