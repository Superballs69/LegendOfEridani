//Bringing back cloning, one step at a time.
...
/*	This Proc was moved to somewhere else after the removal of cloning. Leaving this here for posterity - Tori
...
/obj/machinery/clonepod/proc/growclone(var/datum/dna2/record/R)
	...
	H.setCloneLoss(H.maxHealth * 0.5) //(100 - HUMAN_CRIT_HEALTH_CUSHION) / 100) // We want to put them exactly at the crit level, so we deal this much clone damage
	H.Paralyse(4)
...
/obj/machinery/clonepod/proc/GetCloneReadiness() // Returns a number between 0 and 100
	...
	return between(0, 100) //* (occupant.health - occupant.maxHealth * HUMAN_CRIT_HEALTH_CUSHION / 100) / (occupant.maxHealth * (heal_level - HUMAN_CRIT_HEALTH_CUSHION) / 100), 100)
