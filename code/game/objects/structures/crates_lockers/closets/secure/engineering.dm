...
/obj/structure/closet/secure_closet/engineering_chief/WillContain()
	return list(
		new/datum/atom_creator/weighted(list(/obj/item/clothing/accessory/storage/pouches/load_bearing/brown_vest = 70, /obj/item/clothing/accessory/storage/pouches/load_bearing = 30)),
