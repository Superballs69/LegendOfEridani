...
/obj/item/weapon/disk/secret_project/Initialize()
	...
	subject += " " + pick("a heavy artillery cannon", "a supermatter engine", "a fusion engine", "an atmospheric scrubber",\
	"a human cloning pod", "a microwave oven", "a wormhole drive", "a laser carbine", "an energy pistol",\
	"a wormhole gateway", "a teleporter", "a huge mining drill", "a strange spacecraft", "a space station",\
