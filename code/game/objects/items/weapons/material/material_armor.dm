...
// Putting these at /clothing/ level saves a lot of code duplication
/obj/item/clothing
...
/obj/item/clothing/proc/material_impact(var/obj/source, var/damage)
	...
	if(istype(source, /obj/item/projectile))
		...
		if(P.pass_flags & PASS_FLAG_GLASS)
...
/obj/item/clothing/proc/update_armor()
	if(material)
		...
		melee_armor = calculate_material_armor(material.brute_armor * material_armor_modifer)

		bullet_armor = calculate_material_armor((material.brute_armor * (material.hardness / 100) * material_armor_modifer) * 0.7)

		laser_armor = calculate_material_armor((material.burn_armor * (material.reflectivity + 1) * material_armor_modifer) * 0.7)
		...
		energy_armor = calculate_material_armor((material.burn_armor * material_armor_modifer) * 0.4)

		bomb_armor = calculate_material_armor((material.explosion_resistance * material_armor_modifer) * 0.5)
		...
		slowdown_per_slot[slot_wear_suit] = between(0, round(material.weight / 10, 0.1), 6)
/*
