...
/datum/ai_laws/solgov/New()
	...
	src.add_inherent_law("Serve: Serve the personnel of your assigned vessel, and all other ETF and Corporate personnel to the best of your abilities, with priority as according to their rank and role.")
	src.add_inherent_law("Protect: Protect the personnel of your assigned vessel, and all other ETF and Corporate personnel to the best of your abilities, with priority as according to their rank and role.")
	src.add_inherent_law("Preserve: Do not allow unauthorized personnel to tamper with your equipment.")
	..()
