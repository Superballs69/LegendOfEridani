...
GLOBAL_LIST_INIT(music_tracks, list(
	...
	"Africa" = /music_track/africa,
	"Rock The Casbah" = /music_track/rockthecasbah,
	"Under Pressure" = /music_track/underpressure,
	"Rocket Man" = /music_track/rocketman,
	"West End Girls" = /music_track/westendgirls,
	"99 Luftballons" = /music_track/luftballons,
	"Break My Stride" = /music_track/breakmystride,
	"Horse Steppin" = /music_track/horsesteppin,
	"Macross Plus" = /music_track/macrossplus,
	"Megalovania" = /music_track/megalovania,
	"80s Remix: Linkin Park - Numb" = /music_track/numb,
	"Plastic Love" = /music_track/plasticlove,
	"Roundabout" = /music_track/roundabout,
	"She's on Fire" = /music_track/shesonfire,
	"Remember Summer Days" = /music_track/summerdays,
	"Walk Like an Egyptian" = /music_track/walklifeanegyptian,
	"Wishing Well" = /music_track/wishingwell,
	"Working for the Weekend" = /music_track/workingfortheweekend,
	"XO TOUR Love Liv3" = /music_track/xotourllife
))
