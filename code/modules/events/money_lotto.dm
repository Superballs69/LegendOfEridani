...
/datum/event/money_lotto/start()
	...
	if(prob(50))
		if(all_money_accounts.len)
			...
			if(!D.suspended)
				var/datum/transaction/T = new("Sol News Grand Slam -Stellar- Lottery", "Winner!", winner_sum, "Biesel TCD Terminal #[rand(111,333)]")
				D.do_transaction(T)
				deposit_success = 1
...
/datum/event/money_lotto/announce()
	...
	var/body = "Sol News wishes to congratulate <b>[winner_name]</b> for recieving the Stellar Slam Lottery, and receiving the out of this world sum of [winner_sum] Thalers!"
	if(!deposit_success)
