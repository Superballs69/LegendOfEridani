...
/datum/language/human
	...
	syllables = list(
		...
		"plu", "pou", "que", "res", "son", "sur", "tai", "tio", "tou", "tre", "une", "ure", "ver", "vou", "�ta",
...
/datum/language/frontier
	...
	syllables = list(
		...
		"ve", "ad", "an", "ar", "at", "ch", "de", "en", "er", "et", "f�", "ge", "ha", "ig", "in", "ka", "la",
		"li", "ll", "me", "na", "nd", "ng", "oc", "om", "or", "ra", "re", "sk", "st", "ta", "te", "ti", "tt",
		"va", "�r", "�r", "ai", "an", "ar", "au", "ce", "ch", "co", "de", "em", "en", "er", "es", "et", "eu",
		...
		"var", "ver", "vis", "ade", "all", "and", "ans", "ara", "att", "den", "der", "det", "era", "ett", "f�r",
...
/datum/language/union
	...
	syllables = list(
		...
		"mang", "mao", "me", "mei", "men", "meng", "mi", "mian", "miao", "mie", "min", "ming", "miu", "mo", "mou", "mu", "na",
		...
		"ri", "rong", "rou", "ru", "rua", "ruan", "rui", "run", "ruo", "sa", "sai", "san", "sang", "sao", "se", "sei", "sen", "seng", "sha",
		...
		"xu", "xuan", "xue", "xun", "ya", "yan", "yang", "yao", "ye", "yi", "yin", "ying", "yong", "you", "yu", "yuan", "yue",
