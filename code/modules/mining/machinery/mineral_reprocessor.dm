...
#define ORE_ALLOY    1
#define ORE_RELEASE	 2

/obj/machinery/mineral/reprocessing_unit
...
/obj/machinery/mineral/reprocessing_unit/Process()
...
/obj/machinery/mineral/reprocessing_unit/Topic(href, href_list)
	if((. = ..()))
		return
