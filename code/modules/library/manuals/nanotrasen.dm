...
/obj/item/weapon/book/manual/anomaly_testing
	...
	dat = {"<html>
				...
				<br>
				By employing a patented semi-phased alloy with unique and fascinating spacetime interaction properties, Ward's contraption is able to 'harvest' energy, store
...
/obj/item/weapon/book/manual/stasis
	...
	dat = {"<html>
				...
				It was in examining the effects of decelerated, spacetime, high energy particles when transphased through spacetime that the effects where primarily noticed.
				Due to exigent properties of that dimension, transphasing those particles capable of existing in spacetime with high stability levels has the effect of bringing
