/datum/species/nabber
	...
	assisted_langs = list(LANGUAGE_GALCOM, LANGUAGE_LUNAR, LANGUAGE_GUTTER, LANGUAGE_UNATHI, LANGUAGE_SKRELLIAN, LANGUAGE_SOL_COMMON, LANGUAGE_EAL, LANGUAGE_FRONTIER_BASIC, LANGUAGE_SPACER, LANGUAGE_UNION_STANDARD, LANGUAGE_SIIK_MAAS)
	min_age = 8
	max_age = 40
