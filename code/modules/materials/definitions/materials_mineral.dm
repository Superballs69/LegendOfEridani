...
/material/phoron/supermatter
	...
	lore_text = "Hypercrystalline supermatter is a subset of non-baryonic 'exotic' matter. It is found mostly in the heart of large stars, and features heavily in various technology."
	icon_colour = "#ffff00"
	radioactivity = 20
