/decl/prefab/ic_assembly/hand_teleporter
	...
	data = {"{'assembly':{'type':'type-c electronic assembly','name':'Hand Teleporter', 'detail_color':'#5d99be'},'components':\[{'type':'teleporter locator'},{'type':'wormhole rift generator'},{'type':'button','name':'Open Rift'}\],'wires':\[\[\[1,'O',1\],\[2,'I',1\]\],\[\[2,'A',1\],\[3,'A',1\]\]\]}"}
