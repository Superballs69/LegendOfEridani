//Shouldn't be a lot in here, only eclipse versions of existing machines that need a different access req or something along those lines.

/obj/machinery/vending/medical/eclipse
	req_access = list(access_medical)

/obj/machinery/drone_fabricator/eclipse
	fabricator_tag = "EEV Eclipse Maintenance"

/obj/machinery/drone_fabricator/eclipse/adv
	name = "advanced drone fabricator"
	fabricator_tag = "EFV Arrow Maintenance"
	drone_type = /mob/living/silicon/robot/drone/construction

//telecommunications gubbins for eclipse-specific networks
