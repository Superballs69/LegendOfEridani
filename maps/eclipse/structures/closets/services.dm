...
/obj/structure/closet/chefcloset_eclipse
	name = "chef's closet"
	desc = "It's a storage unit for foodservice equipment."
	icon_state = "black"
	icon_closed = "black"

/obj/structure/closet/chefcloset_eclipse/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/hydroponics_eclipse //done so that it has no access reqs
...
/obj/structure/closet/secure_closet/hydroponics_eclipse/WillContain()
	return list(
...
/obj/structure/closet/jcloset_eclipse
	name = "custodial closet"
	desc = "It's a storage unit for janitorial equipment."
	icon_state = "mixed"
	icon_closed = "mixed"

/obj/structure/closet/jcloset_eclipse/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/bar_eclipse
	name = "bar locker"
	desc = "It's a storage unit for bar equipment."
	req_access = list(access_bar)

/obj/structure/closet/secure_closet/bar_eclipse/WillContain()
	return list(
