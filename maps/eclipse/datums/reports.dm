...
/datum/computer_file/report/recipient/crew_transfer/generate_fields()
	...
	add_field(/datum/report_field/instruction, "EEV Eclipse - Office of the Head of Personnel")
	add_field(/datum/report_field/people/from_manifest, "Name (Head of Personnel)")
	...
	xo_fields += add_field(/datum/report_field/signature, "Head of Personnel's signature")
...
/datum/computer_file/report/recipient/sec/investigation
	form_name = "ETF-SEC-43"
	title = "Investigation Report"
	available_on_ntnet = 1

/datum/computer_file/report/recipient/sec/investigation/generate_fields()
	..()
	add_field(/datum/report_field/instruction, "EEV Eclipse Security Department")
...
/datum/computer_file/report/recipient/docked/generate_fields()
	..()
	add_field(/datum/report_field/instruction, "EEV Eclipse Supply and Hangar Management Department")
...
/datum/computer_file/report/recipient/fauna/generate_fields()
	..()
	add_field(/datum/report_field/instruction, "EEV Eclipse Expeditions")
...
/datum/computer_file/report/recipient/nt/proc/add_header()
	add_field(/datum/report_field/simple_text, "Vessel", "EEV Eclipse")
	add_field(/datum/report_field/date, "Date")
	add_field(/datum/report_field/time, "Time")
...
/datum/computer_file/report/recipient/nt/visa
	form_name = "C-0952"
	title = "Corporate Eridani Trade Federation Work Visa Request Form"
	available_on_ntnet = 1
...
/datum/computer_file/report/recipient/sol
	logo = "\[solcrest\]"
	form_name = "ETF-REP-00"

/datum/computer_file/report/recipient/sol/audit
	form_name = "ETF-REP-12"
	title = "EEV Eclipse Department Audit"
	available_on_ntnet = 1
