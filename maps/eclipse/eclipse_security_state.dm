/datum/map/eclipse // setting the map to use this list
	security_state = /decl/security_state/default/eclipsedept

//Eclipse map alert levels. Refer to security_state.dm.
/decl/security_state/default/eclipsedept
	all_security_levels = list(/decl/security_level/default/eclipsedept/code_green, /decl/security_level/default/eclipsedept/code_violet, /decl/security_level/default/eclipsedept/code_orange, /decl/security_level/default/eclipsedept/code_blue, /decl/security_level/default/eclipsedept/code_red, /decl/security_level/default/code_delta)

/decl/security_level/default/eclipsedept
	icon = 'maps/eclipse/icons/security_state.dmi'

/decl/security_level/default/eclipsedept/code_green
	name = "code green"
...
/decl/security_level/default/eclipsedept/code_green/switching_down_to()
...
/decl/security_level/default/eclipsedept/code_violet
	name = "code violet"
...
/decl/security_level/default/eclipsedept/code_orange
	name = "code orange"
...
/decl/security_level/default/eclipsedept/code_blue
	name = "code blue"
	icon = 'icons/misc/security_state.dmi'
...
/decl/security_level/default/eclipsedept/code_red
	name = "code red"
	icon = 'icons/misc/security_state.dmi'
...
/decl/security_level/default/eclipsedept/code_red/switching_up_to()
	security_announcement_red.Announce(up_description, "Attention! Code red alert procedures now in effect!")
	notify_station()
	GLOB.using_map.unbolt_saferooms()

/decl/security_level/default/eclipsedept/code_red/switching_down_to()
