...
/datum/map
	...
	var/list/available_cultural_info = list(
		...
		TAG_CULTURE = list(
			...
			CULTURE_HUMAN_LUNARIAN,
			CULTURE_HUMAN_YAMATO,
			CULTURE_HUMAN_NEWALESIAN,
	...
	var/list/default_cultural_info = list(
		...
		TAG_FACTION =   FACTION_SOL_ALLIANCE,
...
/datum/map/proc/setup_economy()
	news_network.CreateFeedChannel("Sol News", "SolGov Minister of Information", 1, 1)
	news_network.CreateFeedChannel("Eridani Today", "Editor Mike Hammers", 1, 1)
